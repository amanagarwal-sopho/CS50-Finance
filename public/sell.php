<?php
    ...
    else if($_SERVER["REQUEST_METHOD"]== "POST")
    {
        if(isset($_POST["symbol"]))
        {
            ...
            CS50::query("INSERT INTO transactions (user_id,type,symbol,price,shares,time) VALUES(?,'SELL',?,?,?,CURRENT_TIMESTAMP)",$_SESSION["id"],$_POST["symbol"],$stock["price"],$row[0]["share"]);
